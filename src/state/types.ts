...
export type NpcHighlight = {
	...
	floor?: number;
	/** GL buffer hash for direct NPC identification (e.g., "0x1A2B3C4D") */
	buffer_hash?: string;
	/** Additional buffer hashes for NPC variants (e.g., male/female versions) */
	buffer_hash_variants?: string[];
};
...
export type ObjectHighlight = {
	...
	floor?: number;
	/** GL buffer hash for direct object identification */
	buffer_hash?: string;
	/** Additional buffer hashes for object variants */
	buffer_hash_variants?: string[];
};
